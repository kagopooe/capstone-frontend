...
<h5 class="widget-title">Pizza Planet<span></span></h5>
<p>The award-winning fast-food Chain, Bringing Intergalactical Pizza to you!</p>
</div>
</div>
...
/* Copy Right Footer */
.footer-copyright {	background: #cc0000;	padding: 5px 0;}
